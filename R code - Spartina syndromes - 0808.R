...
set.seed(123)
FILE_ALL <- "Raw data - Spartina syndromes - 0808.xlsx"
...
TNR9_BI <- fp_text(font.family = "Times New Roman", font.size = 9, bold = TRUE, italic = TRUE)

# ============================================================
# 1. Figure 2: collection-site map
# ============================================================
...
# ============================================================
# 2. LMM, Figure 3, Table S2 and Table S6
# ============================================================
...
caption_S6 <- fpar(
  ftext("Table S6 Linear mixed-model comparisons of dependent variables among native and introduced range groups.", TNR10_B)
)
...
caption_S2 <- fpar(
  ...
  ftext(" and ", TNR10),
  ftext("p", TNR10_I),
  ftext(" values from linear and quadratic regressions testing latitudinal variation in plant traits and generalist herbivore consumption in ", TNR10),
...
# ============================================================
# 3. Trait screening, Table S3 and Table S4
# ============================================================
...
caption_S3 <- fpar(
  ftext("Table S3 Spearman's rank correlations among plant traits.", TNR10_B)
)
...
caption_S4 <- fpar(
  ftext("Table S4 Linear regressions testing effects of plant nutritional and putative defensive traits on leaf consumption by ", TNR10_B),
  ftext("Laelia coenosa", TNR10_BI),
  ftext(" and ", TNR10_B),
  ftext("Locusta migratoria", TNR10_BI),
  ftext(".", TNR10_B)
)
...
# ============================================================
# 4. Syndrome analysis, Figure 4, Figure S3 and Table S7
# ============================================================
...
caption_S7 <- fpar(
  ftext("Table S7 Contributions of individual traits to clusters and differences among clusters across ", TNR9_B),
  ftext("Spartina alterniflora", TNR9_BI),
  ftext(" families.", TNR9_B)
)
...
# ============================================================
# 5. Phenotypic selection analysis and Table 1
# ============================================================
...
caption_1 <- fpar(
  ftext("Table 1 Phenotypic selection analysis of ", TNR10_B),
  ftext("Spartina alterniflora", TNR10_BI),
  ftext(" traits using total biomass and seed set as fitness measures.", TNR10_B)
)
...
# ============================================================
# 6. Climate analysis, Table 2, Table S5 and Figure S4
# ============================================================
...
caption_2 <- fpar(
  ftext("Table 2 Best regression models predicting variation in ", TNR10_B),
  ftext("Spartina alterniflora", TNR10_BI),
  ftext(" traits.", TNR10_B)
)
...
caption_S5 <- fpar(
  ftext("Table S5 Five lowest-AIC multiple regression models predicting variation in ", TNR10_B),
  ftext("Spartina alterniflora", TNR10_BI),
  ftext(" traits.", TNR10_B)
)
